  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Align(alignment: Alignment.center, child: Icon(Icons.pool, color: Colors.white, size: 80)),
        Align(
...
class LandingSearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(top: 5, right: 5, left: 20, bottom: 5),
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(blurRadius: 20, offset: Offset.zero, color: Colors.black.withOpacity(0.1))
            ]),
        child: ClipRRect(
            borderRadius: BorderRadius.circular(40),
            child: Container(
                    ...
                    Column(
                      children: [
                        Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: NetworkImage(attraction!.imgPath!), fit: BoxFit.cover))),
                        Container(
                            height: 150,
                            padding: EdgeInsets.all(20),
                            child:
                              ...
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Row(children: [
                                  Icon(Icons.pin_drop,
                                      color: Colors.grey.withOpacity(0.7), size: 12),
                                  SizedBox(width: 5),
            ...
            children: List.generate(barItems.length, (index) {
              ...
              return GestureDetector(
                  ...
                  child: Column(children: [
                    Icon(barItem.icon, color: barItem.isSelected! ? mainThemeColor : Colors.grey),
                    Text(barItem.label!,
                        style: TextStyle(
    ...
    return Row(
      children: [
        Row(
          ...
          return Icon(index < this.rating! ? Icons.star : Icons.star_border, color: Colors.yellow);
        })),
        SizedBox(width: 5),
